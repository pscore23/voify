...
PAD: tuple[tuple[int, int], tuple[int, int]] = ((5, 0), (30, 40))

# autopep8: off
LAYOUT: list = [
    [sg.Text("インストール済みの pip ライブラリ:")],
    [[sg.Input(lib, disabled=True, text_color="Black", background_color="White")] for lib in _get_all_lib()],
    [sg.Input(pad=PAD), sg.Text("を", pad=PAD), sg.Combo(["インストール", "アンインストール"], "インストール", size=(16, None), pad=PAD, readonly=True), sg.Button("実行", button_color="Gray", pad=PAD, key="-START-")],
