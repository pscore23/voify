...
LAYOUT: list[list[Text] | list[Column] | list[Input | Text | Combo | Button] | list[Button]] = [
    ...
    [sg.Column([[sg.Input(lib, disabled=True, text_color="Red", background_color="White")] if require_update(lib) else [sg.Input(lib, disabled=True, text_color="Black", background_color="White")] for lib in get_all_lib()], scrollable=True)],
