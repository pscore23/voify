...
from internal._common_func import _get_all_lib, _require_update
...
LAYOUT: list[list[Text] | list[list[Input]] | list[Input | Text | Combo | Button] | list[Button]] = [
    ...
    [[sg.Input(lib, disabled=True, text_color="Red", background_color="White")] if _require_update(lib) else [sg.Input(lib, disabled=True, text_color="Black", background_color="White")] for lib in _get_all_lib()],
